...
var Meals, Category, kitchens;

var MealRepository = {
    getAll: function (user_id) {
        if (lang.acceptedLanguage == 'en') {
            kitchens = ['kitchen_id', 'category_id', ['name_en', 'name'], 'user_id', 'image', ['description_ar', 'description'], 'final_rate', 'start_time', 'end_time', 'served_count', 'featured', 'final_order_pakaging_rate', 'final_value_rate', 'final_delivery_rate', 'final_quality_rate'];
        ...
        return new Promise(function (resolve, reject) {
            ...
            models.Meals.findAll({
                attributes: Meals, where: { active: 1 }, include: [{ model: models.kitchens, attributes: kitchens }, { model: models.Categories, attributes: Category }, {
                    required: false,
    ...
    get_featured: function (page, sortBy, user_id) {
    ...
    get_related_meals: function (menu_id, category_id, user_id) {
        if (lang.acceptedLanguage == 'en') {
            kitchens = ['kitchen_id', 'category_id', ['name_en', 'name'], 'user_id', 'image', ['description_ar', 'description'], 'final_rate', 'start_time', 'end_time', 'served_count', 'featured', 'final_order_pakaging_rate', 'final_value_rate', 'final_delivery_rate', 'final_quality_rate'];
            Category = ['category_id', ['name_en', 'name'], 'active', 'image'];
            Meals = ['meal_id', ['name_en', 'name'], ['description_en', 'description'], 'menu_id', 'image', 'price_weekly', 'type', 'price', 'price_monthly', 'total_served', 'category_id', 'kitchen_id', 'featured', 'final_rate'];
        ...
        return new Promise(function (resolve, reject) {
            ...
            models.Meals.findAll({
                ...
                attributes: Meals,
                where: {
                    active: 1, category_id: category_id, menu_id: { [Op.ne]: menu_id }
