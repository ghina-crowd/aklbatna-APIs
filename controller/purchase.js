...
router.get('/admin/orders/get/paid/:page', async function (req, res) {
    lang = req.headers.language;
    var errors = validationResult(req);
    if (errors.array().length == 0) {
        var lang = req.headers.language;
        ...
        return new Promise(function (resolve, reject) {
            PurchaseService.getOrders(1, req.params.page).then(orders => {
                resolve(orders);
                languageService.get_lang(lang, 'SUCCESS').then(msg => {
                    res.json({
                        status: statics.STATUS_SUCCESS,
...
router.get('/admin/orders/get/unpaid', async function (req, res) {
    lang = req.headers.language;
    var errors = validationResult(req);
    if (errors.array().length == 0) {
        var lang = req.headers.language;
        ...
        return new Promise(function (resolve, reject) {
            PurchaseService.getOrders(0, 12).then(orders => {
                resolve(orders);
                languageService.get_lang(lang, 'SUCCESS').then(msg => {
                    res.json({
                        status: statics.STATUS_SUCCESS,
...
router.post('/order/create',
    ...
    async function (req, res) {
        ...
        if (errors.array().length == 0) {
            ...
            if (!credentials.payment_type || !isNumber(credentials.payment_type)) {
                res.json({
                    status: statics.STATUS_FAILURE,
                    code: codes.FAILURE,
                ...
                return new Promise(function (resolve, reject) {
                    PurchaseService.CreatePurchaseMany(credentials, id).then(purchase => {
                        resolve(purchase);
                        languageService.get_lang(lang, 'SUCCESS').then(msg => {
                            res.json({
                                status: statics.STATUS_SUCCESS,
...
router.put('/order/update',
    async function (req, res) {
        ...
        if (errors.array().length == 0) {
            ...
            if (!credentials.order_id || !isNumber(credentials.order_id)) {
                res.json({
                    status: statics.STATUS_FAILURE,
                    code: codes.FAILURE,
                    message: 'order_id',
            ...
            } else if (!credentials.payment_status || !isNumber(credentials.payment_status)) {
                res.json({
                    status: statics.STATUS_FAILURE,
                    code: codes.FAILURE,
                    message: 'payment_type',
                ...
                return new Promise(function (resolve, reject) {
                    PurchaseService.UpdateOrder(credentials, id).then(purchase => {
                        resolve(purchase);
                        languageService.get_lang(lang, 'SUCCESS').then(msg => {
                            res.json({
                                status: statics.STATUS_SUCCESS,
...
router.get('/admin/get/:deal_id', async function (req, res) {
    lang = req.headers.language;
    var errors = validationResult(req);
    if (errors.array().length == 0) {
        var lang = req.headers.language;
        ...
        return new Promise(function (resolve, reject) {
            PurchaseService.GetAllByDeal(req.params.deal_id).then(purchases => {
                resolve(purchases);
                languageService.get_lang(lang, 'SUCCESS').then(msg => {
                    res.json({
                        status: statics.STATUS_SUCCESS,
...
router.delete('/admin/order/delete/:order_id', async function (req, res) {
    lang = req.headers.language;
    var errors = validationResult(req);
    if (errors.array().length == 0) {
        var lang = req.headers.language;
        ...
        return new Promise(function (resolve, reject) {
            ...
            PurchaseService.DeleteOrder(req.params.order_id).then(response => {
                resolve(response);
                if (response == null) {
                    languageService.get_lang(lang, 'DATA_NOT_FOUND').then(msg => {
                        res.json({
