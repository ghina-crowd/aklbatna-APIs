...
<<<<<<< HEAD
            .sort()
            .forEach(([name, value]) => {
            url.searchParams.set(interfaces_1.QueryParams[name], (value === null || value === void 0 ? void 0 : value.toString()) || '');
=======
...
ImageUrl = __decorate([
    ...
    __param(0, tsyringe_1.inject('endpoint')),
    __param(1, tsyringe_1.inject(signed_url_service_1.UrlSigner)),
